    ...
    return (
        <main className="min-h-screen p-8">
            <motion.div
                ...
                className="mb-8"
            >
                <h1 className="text-3xl font-bold text-slate-900 mb-1">Transactions</h1>
                                ...
                                <Card className="border-violet-200 shadow-xl shadow-violet-100/50">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-8">
                                        <div className="bg-violet-50 p-4 rounded-xl">
                                            <p className="text-xs font-semibold text-violet-600 uppercase tracking-wide">Membership ID</p>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    min="0"
                                                    step="0.01"
                                                    className="w-full pl-10 pr-4 py-4 text-3xl font-bold text-slate-900 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 outline-none transition-all placeholder:text-slate-300"
                                                    placeholder="0.00"
                                                    autoFocus
                                                />
                                            </div>
                                    ...
                                    <>
                                        ...
                                        <div className="space-y-4 mb-8">
                                            ...
                                            <div className="pt-4 border-t border-slate-100 flex justify-between items-center">
                                                ...
                                                <span className="text-2xl font-bold text-violet-600 flex items-center gap-1">
                                                    +{pointsEarned}
