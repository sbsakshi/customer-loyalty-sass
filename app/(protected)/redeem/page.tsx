        ...
        <main className="min-h-screen pb-20 bg-slate-50/50">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <motion.div
                    ...
                    className="mb-8"
                >
                    <h1 className="text-3xl font-bold text-slate-900">Redeem Points</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            {!selectedCustomer ? (
                                ...
                                >
                                    <Card className="border-orange-200 shadow-xl shadow-orange-100/50">
                                        ...
                                        <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white p-6 rounded-2xl mb-8 relative overflow-hidden">
                                            <p className="text-orange-100 uppercase text-xs font-semibold tracking-wider mb-1">Available Balance</p>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full pl-12 pr-4 py-4 text-3xl font-bold text-slate-900 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all placeholder:text-slate-300"
                                                        placeholder="0"
                                                        autoFocus
                                                    />
                                                </div>
                    ...
                    <div className="md:col-span-1">
                        <AnimatePresence>
                            ...
                            >
                                <Card className={success ? "bg-orange-500 text-white border-orange-400" : ""}>
                                    {success ? (
                                        <motion.div
                                        ...
                                        >
                                            ...
                                            <p className="text-orange-100">Balance updated.</p>
                                        </motion.div>
                                    ) : (
                                        <>
                                            ...
                                            <Button
                                                className="w-full h-12 text-lg shadow-xl shadow-orange-500/20 bg-orange-350 hover:bg-orange-700"
